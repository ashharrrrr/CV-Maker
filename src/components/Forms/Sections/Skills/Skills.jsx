...
export default function Skills({ skills,handleDisplayContentSections, handleDisplayContentSkillsForm }) {
  ...
  return (
    <div className="flex flex-col space-y-2">
      <button onClick={handleExpandSkills} className={`${expandSkills ? "rounded-t-2xl" : "rounded-2xl"} bg-white p-10 flex flex-row cursor-pointer hover:opacity-60 justify-between items-center`}>
